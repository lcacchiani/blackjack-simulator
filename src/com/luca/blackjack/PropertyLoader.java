...
public abstract class PropertyLoader {
	 ...
	 * 
	 * @param name
	 *            classpath resource name [may not be <code>null</code>]
	 * @param loader
	 *            classloader through which to load the resource [<code>null</code> is
	 *            equivalent to the application loader]
	 * 
	 * @return resource converted to java.util.Properties [may be <code>null</code> if the
